...
class OtherViewController: UITableViewController {
    ...
    override func numberOfSections(in tableView: UITableView) -> Int {
        return OtherTutorials.instance.tutorials.count
    }
    
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let label = UILabel()
        label.font = UIFont.boldSystemFont(ofSize: 20)
        label.text = "\t" + OtherTutorials.instance.tutorials[section][0].headerText
        return label
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.tutorials = OtherTutorials.instance.tutorials[indexPath.section]
        return cell
    }
